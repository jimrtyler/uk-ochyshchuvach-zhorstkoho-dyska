...
#GUI Variables
$FormTitleText = "Очищувач диска від Джима Тайлера (PowerShellEngineer.com)"
$SelectDiskLabelText = "Виберіть диск:"
$FreeSpaceLabelText = "Вільне місце (гігабайти): "
$TotalSpaceLabelText = "Загальний простір (гігабайти): "
$JunkFoundLabelText = "знайдено сміття (гігабайти):"
$CleanDiskBtnText = "Очистити диск *Видалити файли*"
$SpaceCleanedLabelText = "Очищений простір (гігабайти): "
$LogFileLabelText = "Знайдено файл журналу: $abcdefg"
$CreditLabelText = "Сценарій Джима Тайлера - PowerShellEngineer.com"
$LogFileLocatedText = "Файл журналу знайдено"
$AnalyzingDriveText = "Аналіз дисків..."
$BrowsersAreRunningText = "Браузери запущені... Повідомити користувача..."
$PleaseCloseBrowsersText = "Будь ласка, закрийте всі веб-браузери та повторіть спробу."
$CleaningDriveText = "Очищення диска..."
